(function ($) {
	...
	this.Topbar = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.$el.html('<img class="logo" src="' + Dex.resourcePrefix + 'pokemonshowdownbeta.png?v=smash-logo-20260721" srcset="' + Dex.resourcePrefix + 'pokemonshowdownbeta@2x.png?v=smash-logo-20260721 2x" alt="Smash Showdown" width="146" height="44" /><div class="maintabbarbottom"></div><div class="tabbar maintabbar"><div class="inner"></div></div><div class="userbar"></div>');
