...
PS.addRoom({id:id,title:title,connected:'init',autofocus:false});
}
...
prefix=Config.defaultserver.prefix||'/showdown';this.
protocol=Config.defaultserver.protocol==='http'?
'http':Config.defaultserver.protocol==='https'?'https':Config.defaultserver.httpport?'https':'http';this.
groups={
'#':{
name:"Room Owner (#)",
type:'leadership',
...
_this7=_PSStreamModel4.call(this)||this;_this7.id=void 0;_this7.title="";_this7.type='';_this7.isPlaceholder=false;_this7.classType='';_this7.location='left';_this7.closable=true;_this7.connected=false;_this7.canConnect=false;_this7.connectWhenLoggedIn=false;_this7.onParentFocus=null;_this7.onParentKeyDown=null;_this7.width=0;_this7.height=0;_this7.focusNextUpdate=false;_this7.parentElem=null;_this7.parentRoomid=null;_this7.rightPopup=false;_this7.notifications=[];_this7.isSubtleNotifying=false;_this7.minimized=false;_this7.caughtError=void 0;_this7.noURL=void 0;_this7.args=void 0;_this7.
...
var id=/[^a-z0-9-]/.test(title)?toID(title):title;
_this11.addRoom({id:id,title:title,connected:true,autofocus:false});
}
}
...
}_inheritsLoose(_class,_PSModel);var _proto7=_class.prototype;_proto7.roomWidthBreakpointPassed=function roomWidthBreakpointPassed(oldWidth,newWidth){return oldWidth<550!==newWidth<550||oldWidth<620!==newWidth<620||oldWidth<=700!==newWidth<=700;};_proto7.
...
var headerWidth=viewportWidth<=700?
NARROW_MODE_HEADER_WIDTH:VERTICAL_HEADER_WIDTH;
var roomWidth=totalWidth+1-headerWidth;
needsUpdate||(needsUpdate=this.roomWidthBreakpointPassed(this.panel.width,roomWidth));
this.panel.width=roomWidth;
this.panel.height=totalHeight-30;
}else if(leftPanelWidth){
var rightPanelWidth=totalWidth+1-leftPanelWidth;
needsUpdate||(needsUpdate=this.roomWidthBreakpointPassed(this.leftPanel.width,leftPanelWidth));
needsUpdate||(needsUpdate=this.roomWidthBreakpointPassed(this.rightPanel.width,rightPanelWidth));
...
needsUpdate||(needsUpdate=this.roomWidthBreakpointPassed(this.panel.width,totalWidth));
...
room.onParentFocus==null||room.onParentFocus();
};_proto7.
