...
class PSServer {
	...
	prefix = Config.defaultserver.prefix || '/showdown';
	protocol: 'http' | 'https' = Config.defaultserver.protocol === 'http' ?
		'http' : Config.defaultserver.protocol === 'https' ? 'https' : Config.defaultserver.httpport ? 'https' : 'http';
